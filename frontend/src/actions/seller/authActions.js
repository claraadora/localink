...
export const changePassword = ({ oldPassword, newPassword }) => async (
  ...
  try {
    ...
    dispatch(setAlert("Changed password successfully", "success"));
  } catch (err) {
    const errors = err.response.data.errors;
...
export const changeEmail = ({ email }) => async (dispatch) => {
  ...
  try {
    ...
    dispatch(setAlert("Changed email successfully", "success"));
  } catch (err) {
    const errors = err.response.data.errors;
...
export const addUser = (data) => async (dispatch) => {
  ...
  try {
    ...
    dispatch(
      setAlert(
        "An invitation email has been sent to the requested user.",
        "success"
      )
    );
  } catch (err) {
