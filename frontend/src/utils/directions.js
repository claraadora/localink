export const calculateAndDisplayRoute = (directionsService, i) => {
...
export const createMarker = (latLng, i) => {
...
export const createPolyline = (start, i) => {
...
export const setTextDirections = (polyline, directionsRenderer) => {
  console.log("std");
